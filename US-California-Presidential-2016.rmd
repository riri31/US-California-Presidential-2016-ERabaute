...
p3 <- qmplot(Longitude, Latitude, data = data_campaign.byzip.latlong.losangeles,size = n/400,  color=cand_nm,show.legend=F, aes(alpha=I(0.5)))+
  facet_wrap(~cand_nm)
...
qmplot(Longitude, Latitude, data = data_campaign.byzip.latlong.california,size = n,  color=cand_nm, show.legend=F,aes(alpha=I(0.1)))+
  facet_wrap(~cand_nm)
```
